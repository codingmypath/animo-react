...
function UpdateEntry ({onSave, onEntry, entryDate}) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        console.log('params.entryId:', params.entryId)
        try {
            setError(false);
    ...
    return (
        ...
        <div className="title-form p-4">
            ...
            <p id="titleShow"></p>
            <input onChange={handleChange} className="input" type="text" name="title" id="title" placeholder="Title" defaultValue={formData.title} required />
        </div>
        ...
        <div className="textbox-div">
            <textarea onChange={handleChange} className="input focus:outline-none w-full" id="description" placeholder="Today.." value={formData.description} name="description" rows="5" cols="35" required="required"></textarea><br />
        </div>
        
        <div className="button-div">
            <button className="text-md cursor-pointer bg-darkGreen text-white rounded-sm p-1.5 m-1.5" type="submit" id="saveButton">Update</button>
