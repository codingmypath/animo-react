  ...
  return (
              ...
              
    {
...

     {
      ...
      // />
      <div>
        <form id="deleteEventModal" className="font-mulish bg-lightestGreen text-veryDarkGreen z-20 p-6 font-veryDarkGreen rounded-md w-[375px] h-[450px]  absolute m-auto text-center left-0 right-0 top-0 bottom-0">
            ...
            <p className="p-2 pb-4">{eventForDate(clicked).description}</p>
            ...
            <div id="modalBackDrop" className="top-0 left-0 bottom-0 z-10 absolute backdrop-sepia bg-black bg-opacity-70 w-full h-screen block"></div>
        </div>
    }
