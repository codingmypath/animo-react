  ...
  return (
    <div className='py-20 max-w-lg mx-auto p-2'>
      ...
      <div className='cursor-pointer self-center'>
        ...
        <button disabled={loading} className='bg-darkGreen text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80'>
          {loading ? 'Loading...' : 'Update' }
        </button>
        <Link to={"/"} className='bg-middleGreen text-white p-3 rounded-lg uppercase text-center hover:opacity-95'>
          Add Journal Entry
        </Link>
      </form>
